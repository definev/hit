...
class _HitDetailsPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (node == null) {
      return const _EmptyState('Select a node, or use Select / Probe.');
    }
    if (node.kind == 'group') {
    ...
    final String? sizeValue = paintSize == null && hitSize == null
        ? null
        : [
        ...
        if (paintSize != null ||
          ...
          if (sizeValue != null)
            _KvRow(
              ...
              value:
                  sizeInsight == null ? sizeValue : '$sizeValue  $sizeInsight',
            ),
          ...
          children: [
            ...
            Expanded(
              child: Text(
                ...
                '${outside ? 'outside HitScope' : 'no HitScope'}  ·  $count',
                maxLines: 1,
...
String? _sizeInsight(Object? paintRaw, Object? hitRaw) {
  ...
  if (areaRatio >= 1.05) {
    return '$dx×$dy · ${areaRatio.toStringAsFixed(areaRatio >= 10 ? 0 : 1)}×';
  }
  return '$dx×$dy';
}
